...
from empresas import views as em
urlpatterns = [
    path("", views.index, name="index"),
    path("index2", views.index, name="index2"),
    path("add_empresas", em.add_empresas, name="add_empresas"),
    path("add_tickets", views.add_tickets, name="add_tickets"),
    path("index2", views.index2, name="index2"),
    path("ini_sup", views.ini_sup, name="ini_sup"),
    path("empresas", views.empresas, name="empresas"),
    path("relatorio_empresas", em.relatorio_empresas, name="relatorio_empresas"),
